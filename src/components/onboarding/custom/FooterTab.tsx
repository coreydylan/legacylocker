    ...
    <div className={cn(
      ...
      <div className="flex items-center space-x-3 rounded-lg border border-gray-200 p-3 bg-gray-50/50">
            <Switch
                ...
                disabled={isLocked}
            />
            <Label htmlFor={`enable-footer-${data.month}-${data.year}`} className="font-medium text-neutral-700 cursor-pointer">
       ...
       <div className={cn(
           ...
           <div className="space-y-2">
             <div className="flex justify-between items-center">
                  <Label htmlFor={`footer-${data.month}-${data.year}`} className="text-sm font-medium">
             ...
             <Textarea
               ...
               className="min-h-[60px] rounded-lg border-gray-200 px-4 py-3 focus:ring-1 focus:ring-neutral-300 disabled:bg-gray-100 disabled:cursor-not-allowed"
